...
|-------------------------------------------------------|---------------|---------------|
|Footfall Oracle Boost                                  | 0.00          | 0.75X         |
...
|Final Boost Multiplier                                 | N/A           | 0.75X         |
|Total MCP per res12 hex                                | 16            | 12            |

### Example 2 - Outdoor CBRS & Wi-Fi
|Example                                                | Type          | Multiplier    |
|-------------------------------------------------------|---------------|---------------|
|Footfall Oracle Boost                                  | 0.00          | 2.00X         |
|Land Type Oracle Boost                                 | Water         | 1.50X         |
...
|Final Boost Multiplier                                 | N/A           | 11.25X        |
|Total MCP per res12 hex                                | 16            | 180           |
...
|Example                                                | Type          | Multiplier    |
|-------------------------------------------------------|---------------|---------------|
|Footfall Oracle Boost                                  | 1.01+         | 2.00X         |
|Land Type Oracle Boost                                 | Built-up      | 1.50X         |
|Urbanization Oracle Boost                              | Non-urbanized | 0.25X         |
|Hex Coverage Limit Multiplier from HIP 85/105          | 3rd Rank      | 0.25X         |
|Service Provider Boost                                 | No Boost      | 1.00X         |
|Final Boost Multiplier                                 | N/A           | 0.1875X       |
|Total MCP per res12 hex                                | 16            | 3             |
...
|Service Provider Boost                                 | No Boost      | 1.00X         |
|Hex Coverage Limit Multiplier from HIP 85/105          | 1st Rank      | 1.00X         |
|Final Boost Multiplier                                 | N/A           | 3.00X         |
|Total MCP per res12 hex                                | 16            | 48            |
...
|Hex Coverage Limit Multiplier from HIP 85/105          | 1st Rank      | 1.00X         |
|Service Provider Boost                                 | No Boost      | 1.00X         |
|Final Boost Multiplier                                 | N/A           | 0.0188X       |
|Total MCP per res12 hex                                | 16            | 0.30          |
...
|Final Boost Multiplier                                 | N/A           | 7.50X         |
|Total MCP per res12 hex                                | 16            | 120           |
...
|Service Provider Boost                                 | No Boost      | 1.00X         |
|Final Boost Multiplier                                 | N/A           | 3.00X         |
|Total MCP per res12 hex                                | 400           | 1,200         |
